 ...
 * @returns 
 */
export const bindHandlers = (io, getGame, setGame) => {
   ...
   * @returns 
   */
  const join = (socket) => (username, callback) => {
   ...
   * @returns 
   */
  const rejoin = (socket) => (username, callback) => {
   ...
   * @returns 
   */
  const action = (socket) => (actions, callback) => {
   ...
   * @returns 
   */
  const endTurn = (socket) => (_, callback) => {
  ...
  return [join, rejoin, action, endTurn];
